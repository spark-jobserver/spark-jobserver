...
In a yarn-client mode, using H2 in server mode (described below) is advised.
- Run H2 in server mode (http://www.h2database.com/html/download.html, and follow docs.  Note that the version of H2 should match the H2 client version bundled with spark-jobserver, currently 1.3.176.)
