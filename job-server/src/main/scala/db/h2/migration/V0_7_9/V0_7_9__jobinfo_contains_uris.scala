package db.h2.migration.V0_7_9
...
class V0_7_9__jobinfo_contains_uris extends JdbcMigration{
  ...
  override def migrate(c: Connection): Unit = {
    ...
    val createBinIdsColumn = sqlu"""ALTER TABLE JOBS ADD COLUMN BIN_IDS CLOB"""
    val createURIsColumn = sqlu"""ALTER TABLE JOBS ADD COLUMN URIS CLOB"""
